...
public class EnumInJava {
	...
	public static void main(String[] args) {
		...
		System.out.println(getFeeByCountry(Country.India));
		// Doesn't compile
		// System.out.println(getFeeByCountry("China")); // doesn't accpet string
		// System.out.println(getFeeByCountry(Country.China)); // China is not part of
		// the enum
	}

	/*
	 * USA - 10.0 Canada - 12.0 UK - 9.0 Brazil - 9.0 India - 8.0
	 */
